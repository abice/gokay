...
func gkgenLenTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "gkgen/len.tmpl", size: 476, mode: os.FileMode(420), modTime: time.Unix(1477700512, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
